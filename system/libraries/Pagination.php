...
class CI_Pagination {
	...
	protected $prefix						= '';
	protected $suffix						= '';
	protected $total_rows				= 5;
	protected $num_links					= 0;
	public $per_page						= 0;
	public $cur_page						= 0;
	protected $use_page_numbers		= FALSE;
	protected $first_link				= 'İlk';
	protected $first_tag_open			= '<li>';
	protected $first_tag_close			= '</li>';
	protected $last_link					= 'Son';
	protected $last_tag_open			= '<li>';
	protected $last_tag_close			= '</li>';
	protected $next_link					= 'İleri';
	protected $prev_link					= 'Geri';
	protected $uri_segment				= 0;
	protected $full_tag_open			= '<nav class="text-center"><ul class="pagination pagination-sm text-center">';
	protected $full_tag_close			= '</ul></nav>';
	protected $first_url					= '';
	protected $cur_tag_open				= '<li class="active"><a href="javascript:viod();">';
